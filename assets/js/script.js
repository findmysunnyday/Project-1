...
console.log("Game Page Visibility:", gamePage.classList.contains('d-none'));
console.log("Grid Visibility:", document.getElementById('grid').classList.contains('d-none'));
...
function showGameMode() {
  ...
  if (mode === 'classic') {
    document.getElementById('classic-game-container').classList.remove('d-none');
    startClassicGame();
